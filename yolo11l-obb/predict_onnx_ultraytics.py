...
model_path = os.path.join(current_dir, "models", "yolo11l-obb.onnx")
source_path = os.path.join(project_root, "assets", "boats.jpg")

# Load the exported ONNX model
onnx_model = YOLO(model_path)

# Run inference
results = onnx_model(source=source_path, save=True)
